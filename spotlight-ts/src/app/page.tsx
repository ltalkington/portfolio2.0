...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button
        href="assets/Logan_T_Resume.pdf"
        variant="secondary"
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Full Stack, Embedded Systems, and Backend Development.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Logan, a software engineer that is currently based in Saint
            Louis, Missouri. I have built applications in C#, Python,
            JavaScript, and C++.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://x.com/TechTalkLogan"
